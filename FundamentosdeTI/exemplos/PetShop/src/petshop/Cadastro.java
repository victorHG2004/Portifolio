...
public class Cadastro extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        for (Cachorro c : cachorro) {
            ...
            resultado += "Idade: " + c.getIdade() + ".\n";
            resultado += "Matrícula: " + c.getMatricula() + ".\n";
            resultado += "-----------------\n";
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        int matricula = Integer.parseInt(JOptionPane.showInputDialog("Qual o número da matrícula do cachorro que você deseja remover?"));
        for (Cachorro c : cachorro) {
            if (c.getMatricula() == matricula) {
                cachorro.remove(c);
